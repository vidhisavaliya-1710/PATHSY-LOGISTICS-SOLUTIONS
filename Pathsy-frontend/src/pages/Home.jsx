        ...
        <div className="relative z-10 flex items-center justify-center min-h-screen px-4 py-12 sm:px-6 lg:px-8">
          <div className="max-w-7xl w-full text-white">
            ...
            <div className="mt-8 flex flex-col sm:flex-row gap-4">
              <Link
                to="/contact"
                className="w-full sm:w-auto flex items-center justify-center px-6 py-3 rounded-lg bg-[#0052cc] text-white hover:bg-blue-700 transition"
              >
                Request Quote <Quote className="ml-2 w-5 h-5" />
              </Link>

              <Link to="/services" className="w-full sm:w-auto">
                <button className="w-full sm:w-auto flex items-center justify-center px-6 py-3 rounded-lg bg-white text-[#0052cc] hover:bg-gray-100 transition">
