    ...
    <div className="min-h-screen bg-gray-50 py-12 px-4 sm:px-6 lg:px-8">
      <div className="max-w-6xl mx-auto">
        ...
        <div className="bg-white rounded-3xl p-8 sm:p-12  shadow-lg text-center border border-[#e0e0e0] ">
          ...
          <button className="bg-gradient-to-r from-[#26a69a] to-[#fbc02d] text-white px-8 py-4 rounded-xl font-semibold text-lg transition-colors inline-flex items-center gap-2">
