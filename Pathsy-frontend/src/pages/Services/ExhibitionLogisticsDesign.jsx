            ...
            <div className="max-w-6xl mx-auto">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mb-16">
                    ...
                    <div className="bg-gradient-to-br from-blue-50 to-white rounded-2xl shadow-md p-8">
                        ...
                        <h3 className="text-2xl font-bold text-gray-900 mb-2">Exhibition Logistics Services</h3>
                    ...
                    {/* Booth Design Card */}
                    <div className="bg-gradient-to-br from-cyan-50 to-white rounded-2xl shadow-md p-8">
                        ...
                        <h3 className="text-2xl font-bold text-gray-900 mb-2">Booth Design & Setup</h3>
                        <p className="text-gray-600 mb-6">
